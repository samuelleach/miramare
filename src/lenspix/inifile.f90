...
10 write (*,*) 'error reading double for key: '//Key
  ...
  !Reads Key(1), Key(2), etc.
   ...
   function Ini_Read_Logical_Array(Key, index, Default)
     logical, optional, intent(IN) :: Default
     integer, intent(in) :: index
     character (LEN=*), intent(IN) :: Key
     logical Ini_Read_Logical_Array

     if (present(Default)) then
      Ini_Read_Logical_Array = Ini_Read_Logical_Array_File(DefIni, Key, index, Default)
     else
      Ini_Read_Logical_Array = Ini_Read_Logical_Array_File(DefIni, Key, index)
     end if
   end function Ini_Read_Logical_Array


  function Ini_Read_Logical_Array_File(Ini,Key, index, Default)
  !Reads Key(1), Key(2), etc.
    Type(TIniFile) :: Ini
   logical Ini_Read_Logical_Array_File 
   logical, optional, intent(IN) :: Default
   integer, intent(in) :: index
   character (LEN=*), intent(IN) :: Key
   character(LEN=Ini_max_string_len) :: ArrrayKey
     ...
     ArrrayKey = Ini_Key_To_Arraykey(Key,index)
     if (present(Default)) then
      Ini_Read_Logical_Array_File = Ini_Read_Logical_File(Ini, ArrrayKey, Default)
     else
      Ini_Read_Logical_Array_File = Ini_Read_Logical_File(Ini, ArrrayKey)
     end if

   end function Ini_Read_Logical_Array_File
